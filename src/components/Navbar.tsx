    ...
    <header className="sticky top-0 z-40 bg-white/95 backdrop-blur-md border-b border-slate-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        ...
        <button
          ...
          className="flex items-center gap-2 text-left cursor-pointer focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-600 rounded-lg p-1"
        >
        ...
        <div className="flex items-center gap-2 sm:gap-2.5">
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-2.5 py-1.5 bg-amber-50 hover:bg-amber-100 border border-amber-300 text-amber-900 rounded-xl text-xs font-bold transition-all shadow-xs cursor-pointer group"
          ...
          >
            ...
            <span className="font-mono">{aiCredits}</span>
            <span className="hidden lg:inline text-amber-800">Credits</span>
            <span className="px-1.5 py-0.2 bg-amber-200 text-amber-950 text-[10px] font-black rounded uppercase">
              +Add
            </span>
          </button>
          ...
          <button
            ...
            className="hidden sm:flex items-center gap-1.5 px-3 py-1.5 bg-white hover:bg-slate-50 border border-slate-300 hover:border-slate-400 text-slate-700 text-xs sm:text-sm font-semibold rounded-xl transition-all cursor-pointer shadow-xs"
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-3.5 py-2 bg-blue-600 hover:bg-blue-700 active:bg-blue-800 text-white text-xs sm:text-sm font-semibold rounded-xl shadow-xs transition-all whitespace-nowrap cursor-pointer"
          >
          ...
          {user ? (
            <div className="relative" ref={userMenuRef}>
              <button
                ...
                className="flex items-center gap-1.5 p-1.5 sm:px-2.5 sm:py-1.5 rounded-xl border border-slate-200 hover:border-slate-300 text-slate-700 text-xs sm:text-sm font-medium hover:bg-slate-50 transition-colors cursor-pointer"
              ...
              >
                ...
                <span className="hidden xl:inline font-bold text-xs">{user.name.split(' ')[0]}</span>
            ...
            <div className="flex items-center gap-1 sm:gap-1.5">
              <button
                ...
                className="px-3 py-1.5 sm:px-3.5 sm:py-2 text-xs sm:text-sm font-semibold text-slate-700 hover:text-slate-900 border border-slate-200 hover:bg-slate-50 rounded-xl transition-colors whitespace-nowrap cursor-pointer flex items-center gap-1.5"
              >
              ...
              <button
                onClick={() => setActiveTab('login')}
                className="hidden lg:inline-flex px-3.5 py-2 text-xs sm:text-sm font-bold text-blue-700 bg-blue-50 hover:bg-blue-100 border border-blue-200 rounded-xl transition-colors whitespace-nowrap cursor-pointer"
              >
                Sign Up
              </button>
            </div>
      ...
      {/* MOBILE NAV OVERLAY */}
      {mobileMenuOpen && (
        <div className="md:hidden border-t border-slate-200 bg-white px-4 py-3 space-y-2 animate-in fade-in">
          ...
          {user ? (
            <div className="p-3 bg-slate-50 rounded-xl border border-slate-200 flex items-center justify-between">
              ...
              <button
                onClick={handleSignOut}
                className="px-3 py-1.5 bg-rose-50 border border-rose-200 text-rose-700 text-xs font-bold rounded-lg flex items-center gap-1 cursor-pointer"
              >
            ...
            <div className="flex items-center gap-2 pb-1">
              <button
                ...
                className="flex-1 py-2 bg-blue-600 hover:bg-blue-700 text-white text-xs font-bold rounded-xl text-center cursor-pointer"
              >
                Log In / Register
              </button>
            </div>
          ...
          <div className="flex items-center gap-2 pb-2 border-b border-slate-100">
            <button
              ...
              className="flex-1 py-2 bg-blue-50 text-blue-700 text-xs font-bold rounded-xl flex items-center justify-center gap-1.5 cursor-pointer"
            >
            ...
            <button
              ...
              className="flex-1 py-2 bg-amber-50 text-amber-800 text-xs font-bold rounded-xl flex items-center justify-center gap-1.5 cursor-pointer"
            >
          ...
          <button
            ...
            className="w-full text-left px-3 py-2 text-sm font-medium text-slate-700 hover:bg-slate-100 rounded-lg cursor-pointer"
          >
            Dashboard
          </button>
          {navItems.map((item) => (
            <button
              ...
              className={`w-full text-left px-3 py-2 text-sm font-medium rounded-lg cursor-pointer ${
                activeTab === item.id ? 'text-blue-600 bg-blue-50 font-semibold' : 'text-slate-700 hover:bg-slate-100'
              }`}
            >
              {item.label}
            </button>
